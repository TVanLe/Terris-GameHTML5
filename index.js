...
class Board {
    constructor(ctx){
        ...
        this.score = 0;
        this.audioCompleted = new Audio('sounds/clear.wav');
        this.audioOver = new Audio('sounds/overgame.mp3');
        this.gameOver = false;
    ...
    drawCell(xAxis , yAxis , colorId)
    {
        ...
        ctx.fillStyle = 'black';
        ctx.strokeRect(xAxis * BLOCK_SIZE , yAxis * BLOCK_SIZE , BLOCK_SIZE , BLOCK_SIZE);
    }
    ...
    handleCompleteRow() {
      ...
      if(newScore) this.audioCompleted.play();
    }
...
class Brick {
    ...
    moveLeft() {
      if(
        !this.checkCollision(this.rowPos , this.colPos - 1 , this.layout[this.activeIndex])
        ) 
      {
        this.clear();
        this.colPos -- ;
    ...
    moveDown() {
      if(
        !this.checkCollision(this.rowPos + 1, this.colPos , this.layout[this.activeIndex])
        ) 
        {
          this.clear();
          this.rowPos ++;
